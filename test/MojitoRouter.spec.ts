...
describe('MojitoRouter', () => {
  ...
  it('quote', async () => {
    ...
    await expect(router.quote(bigNumberify(0), bigNumberify(100), bigNumberify(200))).to.be.revertedWith(
      'MojitoLibrary: INSUFFICIENT_AMOUNT'
    )
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    pair = new Contract(pairAddress, JSON.stringify(IMojitoPair.abi), provider).connect(wallet)
  })
